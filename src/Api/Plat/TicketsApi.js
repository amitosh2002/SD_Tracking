...
export const ticketSearchQueryApi =`api/platform/v1/tickets/fetch/searchTicket`;// if using axiosClient do not use import from env it already imported into axiosclient
